...
$old_error_handler = set_error_handler("Formulario_Llamada_Bienvenida_scriptcase_error_handler");

function Formulario_Llamada_Bienvenida_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['Formulario_Llamada_Bienvenida']['contr_erro']) && $_SESSION['scriptcase']['Formulario_Llamada_Bienvenida']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Formulario_Llamada_Bienvenida->contr_Formulario_Llamada_Bienvenida->Apl_com_erro = true;
            if ($inicial_Formulario_Llamada_Bienvenida->contr_Formulario_Llamada_Bienvenida->NM_ajax_flag)
            {
                $inicial_Formulario_Llamada_Bienvenida->contr_Formulario_Llamada_Bienvenida->NM_ajax_info['errList']['geral_Formulario_Llamada_Bienvenida'][] = $msg;
                return;
            }
            Formulario_Llamada_Bienvenida_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function Formulario_Llamada_Bienvenida_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Formulario_Llamada_Bienvenida'])  && '' != $_SESSION['scriptcase']['error_icon']['Formulario_Llamada_Bienvenida'])  ? $_SESSION['scriptcase']['error_icon']['Formulario_Llamada_Bienvenida']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['Formulario_Llamada_Bienvenida']) && '' != $_SESSION['scriptcase']['error_close']['Formulario_Llamada_Bienvenida']) ? $_SESSION['scriptcase']['error_close']['Formulario_Llamada_Bienvenida'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Formulario_Llamada_Bienvenida']) && '' != $_SESSION['scriptcase']['error_span_title']['Formulario_Llamada_Bienvenida']) ? $_SESSION['scriptcase']['error_span_title']['Formulario_Llamada_Bienvenida'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Formulario_Llamada_Bienvenida']) && '' != $_SESSION['scriptcase']['error_icon_title']['Formulario_Llamada_Bienvenida']) ? $_SESSION['scriptcase']['error_icon_title']['Formulario_Llamada_Bienvenida'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['Formulario_Llamada_Bienvenida']['error_buffer'] .= ob_get_flush();
}
