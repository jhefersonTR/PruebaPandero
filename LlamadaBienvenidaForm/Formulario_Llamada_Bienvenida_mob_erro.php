...
$old_error_handler = set_error_handler("Formulario_Llamada_Bienvenida_mob_scriptcase_error_handler");

function Formulario_Llamada_Bienvenida_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['Formulario_Llamada_Bienvenida_mob']['contr_erro']) && $_SESSION['scriptcase']['Formulario_Llamada_Bienvenida_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Formulario_Llamada_Bienvenida_mob->contr_Formulario_Llamada_Bienvenida_mob->Apl_com_erro = true;
            if ($inicial_Formulario_Llamada_Bienvenida_mob->contr_Formulario_Llamada_Bienvenida_mob->NM_ajax_flag)
            {
                $inicial_Formulario_Llamada_Bienvenida_mob->contr_Formulario_Llamada_Bienvenida_mob->NM_ajax_info['errList']['geral_Formulario_Llamada_Bienvenida_mob'][] = $msg;
                return;
            }
            Formulario_Llamada_Bienvenida_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function Formulario_Llamada_Bienvenida_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Formulario_Llamada_Bienvenida_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['Formulario_Llamada_Bienvenida_mob'])  ? $_SESSION['scriptcase']['error_icon']['Formulario_Llamada_Bienvenida_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Formulario_Llamada_Bienvenida_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['Formulario_Llamada_Bienvenida_mob']) ? $_SESSION['scriptcase']['error_span_title']['Formulario_Llamada_Bienvenida_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Formulario_Llamada_Bienvenida_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['Formulario_Llamada_Bienvenida_mob']) ? $_SESSION['scriptcase']['error_icon_title']['Formulario_Llamada_Bienvenida_mob'] : '';
?>
