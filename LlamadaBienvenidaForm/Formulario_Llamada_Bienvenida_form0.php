...
<style type="text/css">
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['embutida_pdf']))
 {
 ?>
...
include_once('Formulario_Llamada_Bienvenida_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("Formulario_Llamada_Bienvenida_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['Formulario_Llamada_Bienvenida'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Formulario_Llamada_Bienvenida'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
        ...
        $sCondStyle = ($this->nmgp_botoes['llamada'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "llamada", "scBtnFn_llamada()", "scBtnFn_llamada()", "sc_llamada_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_contratonumero_label" id="hidden_field_label_contratonumero" style="<?php echo $sStyleHidden_contratonumero; ?>"><span id="id_label_contratonumero"><?php echo $this->nm_new_label['contratonumero']; ?></span></TD>
    <TD class="scFormDataOdd css_contratonumero_line" id="hidden_field_data_contratonumero" style="<?php echo $sStyleHidden_contratonumero; ?>"><input type="hidden" name="contratonumero" value="<?php echo $this->form_encode_input($contratonumero); ?>"><span id="id_ajax_label_contratonumero"><?php echo nl2br($contratonumero); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombreedv_label" id="hidden_field_label_nombreedv" style="<?php echo $sStyleHidden_nombreedv; ?>"><span id="id_label_nombreedv"><?php echo $this->nm_new_label['nombreedv']; ?></span></TD>
    <TD class="scFormDataOdd css_nombreedv_line" id="hidden_field_data_nombreedv" style="<?php echo $sStyleHidden_nombreedv; ?>"><input type="hidden" name="nombreedv" value="<?php echo $this->form_encode_input($nombreedv); ?>"><span id="id_ajax_label_nombreedv"><?php echo nl2br($nombreedv); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_supervisor_label" id="hidden_field_label_supervisor" style="<?php echo $sStyleHidden_supervisor; ?>"><span id="id_label_supervisor"><?php echo $this->nm_new_label['supervisor']; ?></span></TD>
    <TD class="scFormDataOdd css_supervisor_line" id="hidden_field_data_supervisor" style="<?php echo $sStyleHidden_supervisor; ?>"><input type="hidden" name="supervisor" value="<?php echo $this->form_encode_input($supervisor); ?>"><span id="id_ajax_label_supervisor"><?php echo nl2br($supervisor); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechaventa_label" id="hidden_field_label_fechaventa" style="<?php echo $sStyleHidden_fechaventa; ?>"><span id="id_label_fechaventa"><?php echo $this->nm_new_label['fechaventa']; ?></span></TD>
    <TD class="scFormDataOdd css_fechaventa_line" id="hidden_field_data_fechaventa" style="<?php echo $sStyleHidden_fechaventa; ?>"><input type="hidden" name="fechaventa" value="<?php echo $this->form_encode_input($fechaventa); ?>"><span id="id_ajax_label_fechaventa"><?php echo nl2br($fechaventa); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_grupofechainauguracion_label" id="hidden_field_label_grupofechainauguracion" style="<?php echo $sStyleHidden_grupofechainauguracion; ?>"><span id="id_label_grupofechainauguracion"><?php echo $this->nm_new_label['grupofechainauguracion']; ?></span></TD>
    <TD class="scFormDataOdd css_grupofechainauguracion_line" id="hidden_field_data_grupofechainauguracion" style="<?php echo $sStyleHidden_grupofechainauguracion; ?>"><input type="hidden" name="grupofechainauguracion" value="<?php echo $this->form_encode_input($grupofechainauguracion); ?>"><span id="id_ajax_label_grupofechainauguracion"><?php echo nl2br($grupofechainauguracion); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombreasociaso_label" id="hidden_field_label_nombreasociaso" style="<?php echo $sStyleHidden_nombreasociaso; ?>"><span id="id_label_nombreasociaso"><?php echo $this->nm_new_label['nombreasociaso']; ?></span></TD>
    <TD class="scFormDataOdd css_nombreasociaso_line" id="hidden_field_data_nombreasociaso" style="<?php echo $sStyleHidden_nombreasociaso; ?>"><input type="hidden" name="nombreasociaso" value="<?php echo $this->form_encode_input($nombreasociaso); ?>"><span id="id_ajax_label_nombreasociaso"><?php echo nl2br($nombreasociaso); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipodocumento1_label" id="hidden_field_label_tipodocumento1" style="<?php echo $sStyleHidden_tipodocumento1; ?>"><span id="id_label_tipodocumento1"><?php echo $this->nm_new_label['tipodocumento1']; ?></span></TD>
    <TD class="scFormDataOdd css_tipodocumento1_line" id="hidden_field_data_tipodocumento1" style="<?php echo $sStyleHidden_tipodocumento1; ?>"><input type="hidden" name="tipodocumento1" value="<?php echo $this->form_encode_input($tipodocumento1); ?>"><span id="id_ajax_label_tipodocumento1"><?php echo nl2br($tipodocumento1); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numerodocumento1_label" id="hidden_field_label_numerodocumento1" style="<?php echo $sStyleHidden_numerodocumento1; ?>"><span id="id_label_numerodocumento1"><?php echo $this->nm_new_label['numerodocumento1']; ?></span></TD>
    <TD class="scFormDataOdd css_numerodocumento1_line" id="hidden_field_data_numerodocumento1" style="<?php echo $sStyleHidden_numerodocumento1; ?>"><input type="hidden" name="numerodocumento1" value="<?php echo $this->form_encode_input($numerodocumento1); ?>"><span id="id_ajax_label_numerodocumento1"><?php echo nl2br($numerodocumento1); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ubicacion_line" id="hidden_field_data_ubicacion" style="<?php echo $sStyleHidden_ubicacion; ?>"><input type="hidden" name="ubicacion" value="<?php echo $this->form_encode_input($ubicacion); ?>"><span id="id_ajax_label_ubicacion"><?php echo nl2br($ubicacion); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_correopersonal1_label" id="hidden_field_label_correopersonal1" style="<?php echo $sStyleHidden_correopersonal1; ?>"><span id="id_label_correopersonal1"><?php echo $this->nm_new_label['correopersonal1']; ?></span></TD>
    <TD class="scFormDataOdd css_correopersonal1_line" id="hidden_field_data_correopersonal1" style="<?php echo $sStyleHidden_correopersonal1; ?>"><input type="hidden" name="correopersonal1" value="<?php echo $this->form_encode_input($correopersonal1); ?>"><span id="id_ajax_label_correopersonal1"><?php echo nl2br($correopersonal1); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_correolaboral1_label" id="hidden_field_label_correolaboral1" style="<?php echo $sStyleHidden_correolaboral1; ?>"><span id="id_label_correolaboral1"><?php echo $this->nm_new_label['correolaboral1']; ?></span></TD>
    <TD class="scFormDataOdd css_correolaboral1_line" id="hidden_field_data_correolaboral1" style="<?php echo $sStyleHidden_correolaboral1; ?>"><input type="hidden" name="correolaboral1" value="<?php echo $this->form_encode_input($correolaboral1); ?>"><span id="id_ajax_label_correolaboral1"><?php echo nl2br($correolaboral1); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf11_label" id="hidden_field_label_tf11" style="<?php echo $sStyleHidden_tf11; ?>"><span id="id_label_tf11"><?php echo $this->nm_new_label['tf11']; ?></span></TD>
    <TD class="scFormDataOdd css_tf11_line" id="hidden_field_data_tf11" style="<?php echo $sStyleHidden_tf11; ?>"><input type="hidden" name="tf11" value="<?php echo $this->form_encode_input($tf11); ?>"><span id="id_ajax_label_tf11"><?php echo nl2br($tf11); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf13_label" id="hidden_field_label_tf13" style="<?php echo $sStyleHidden_tf13; ?>"><span id="id_label_tf13"><?php echo $this->nm_new_label['tf13']; ?></span></TD>
    <TD class="scFormDataOdd css_tf13_line" id="hidden_field_data_tf13" style="<?php echo $sStyleHidden_tf13; ?>"><input type="hidden" name="tf13" value="<?php echo $this->form_encode_input($tf13); ?>"><span id="id_ajax_label_tf13"><?php echo nl2br($tf13); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf12_label" id="hidden_field_label_tf12" style="<?php echo $sStyleHidden_tf12; ?>"><span id="id_label_tf12"><?php echo $this->nm_new_label['tf12']; ?></span></TD>
    <TD class="scFormDataOdd css_tf12_line" id="hidden_field_data_tf12" style="<?php echo $sStyleHidden_tf12; ?>"><input type="hidden" name="tf12" value="<?php echo $this->form_encode_input($tf12); ?>"><span id="id_ajax_label_tf12"><?php echo nl2br($tf12); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf14_label" id="hidden_field_label_tf14" style="<?php echo $sStyleHidden_tf14; ?>"><span id="id_label_tf14"><?php echo $this->nm_new_label['tf14']; ?></span></TD>
    <TD class="scFormDataOdd css_tf14_line" id="hidden_field_data_tf14" style="<?php echo $sStyleHidden_tf14; ?>"><input type="hidden" name="tf14" value="<?php echo $this->form_encode_input($tf14); ?>"><span id="id_ajax_label_tf14"><?php echo nl2br($tf14); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf15_label" id="hidden_field_label_tf15" style="<?php echo $sStyleHidden_tf15; ?>"><span id="id_label_tf15"><?php echo $this->nm_new_label['tf15']; ?></span></TD>
    <TD class="scFormDataOdd css_tf15_line" id="hidden_field_data_tf15" style="<?php echo $sStyleHidden_tf15; ?>"><input type="hidden" name="tf15" value="<?php echo $this->form_encode_input($tf15); ?>"><span id="id_ajax_label_tf15"><?php echo nl2br($tf15); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf16_label" id="hidden_field_label_tf16" style="<?php echo $sStyleHidden_tf16; ?>"><span id="id_label_tf16"><?php echo $this->nm_new_label['tf16']; ?></span></TD>
    <TD class="scFormDataOdd css_tf16_line" id="hidden_field_data_tf16" style="<?php echo $sStyleHidden_tf16; ?>"><input type="hidden" name="tf16" value="<?php echo $this->form_encode_input($tf16); ?>"><span id="id_ajax_label_tf16"><?php echo nl2br($tf16); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf17_label" id="hidden_field_label_tf17" style="<?php echo $sStyleHidden_tf17; ?>"><span id="id_label_tf17"><?php echo $this->nm_new_label['tf17']; ?></span></TD>
    <TD class="scFormDataOdd css_tf17_line" id="hidden_field_data_tf17" style="<?php echo $sStyleHidden_tf17; ?>"><input type="hidden" name="tf17" value="<?php echo $this->form_encode_input($tf17); ?>"><span id="id_ajax_label_tf17"><?php echo nl2br($tf17); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf18_label" id="hidden_field_label_tf18" style="<?php echo $sStyleHidden_tf18; ?>"><span id="id_label_tf18"><?php echo $this->nm_new_label['tf18']; ?></span></TD>
    <TD class="scFormDataOdd css_tf18_line" id="hidden_field_data_tf18" style="<?php echo $sStyleHidden_tf18; ?>"><input type="hidden" name="tf18" value="<?php echo $this->form_encode_input($tf18); ?>"><span id="id_ajax_label_tf18"><?php echo nl2br($tf18); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf19_label" id="hidden_field_label_tf19" style="<?php echo $sStyleHidden_tf19; ?>"><span id="id_label_tf19"><?php echo $this->nm_new_label['tf19']; ?></span></TD>
    <TD class="scFormDataOdd css_tf19_line" id="hidden_field_data_tf19" style="<?php echo $sStyleHidden_tf19; ?>"><input type="hidden" name="tf19" value="<?php echo $this->form_encode_input($tf19); ?>"><span id="id_ajax_label_tf19"><?php echo nl2br($tf19); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombreasociado2_label" id="hidden_field_label_nombreasociado2" style="<?php echo $sStyleHidden_nombreasociado2; ?>"><span id="id_label_nombreasociado2"><?php echo $this->nm_new_label['nombreasociado2']; ?></span></TD>
    <TD class="scFormDataOdd css_nombreasociado2_line" id="hidden_field_data_nombreasociado2" style="<?php echo $sStyleHidden_nombreasociado2; ?>"><input type="hidden" name="nombreasociado2" value="<?php echo $this->form_encode_input($nombreasociado2); ?>"><span id="id_ajax_label_nombreasociado2"><?php echo nl2br($nombreasociado2); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipodocumento2_label" id="hidden_field_label_tipodocumento2" style="<?php echo $sStyleHidden_tipodocumento2; ?>"><span id="id_label_tipodocumento2"><?php echo $this->nm_new_label['tipodocumento2']; ?></span></TD>
    <TD class="scFormDataOdd css_tipodocumento2_line" id="hidden_field_data_tipodocumento2" style="<?php echo $sStyleHidden_tipodocumento2; ?>"><input type="hidden" name="tipodocumento2" value="<?php echo $this->form_encode_input($tipodocumento2); ?>"><span id="id_ajax_label_tipodocumento2"><?php echo nl2br($tipodocumento2); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numerodocumento2_label" id="hidden_field_label_numerodocumento2" style="<?php echo $sStyleHidden_numerodocumento2; ?>"><span id="id_label_numerodocumento2"><?php echo $this->nm_new_label['numerodocumento2']; ?></span></TD>
    <TD class="scFormDataOdd css_numerodocumento2_line" id="hidden_field_data_numerodocumento2" style="<?php echo $sStyleHidden_numerodocumento2; ?>"><input type="hidden" name="numerodocumento2" value="<?php echo $this->form_encode_input($numerodocumento2); ?>"><span id="id_ajax_label_numerodocumento2"><?php echo nl2br($numerodocumento2); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ubicacion2_label" id="hidden_field_label_ubicacion2" style="<?php echo $sStyleHidden_ubicacion2; ?>"><span id="id_label_ubicacion2"><?php echo $this->nm_new_label['ubicacion2']; ?></span></TD>
    <TD class="scFormDataOdd css_ubicacion2_line" id="hidden_field_data_ubicacion2" style="<?php echo $sStyleHidden_ubicacion2; ?>"><input type="hidden" name="ubicacion2" value="<?php echo $this->form_encode_input($ubicacion2); ?>"><span id="id_ajax_label_ubicacion2"><?php echo nl2br($ubicacion2); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_correopersonal2_label" id="hidden_field_label_correopersonal2" style="<?php echo $sStyleHidden_correopersonal2; ?>"><span id="id_label_correopersonal2"><?php echo $this->nm_new_label['correopersonal2']; ?></span></TD>
    <TD class="scFormDataOdd css_correopersonal2_line" id="hidden_field_data_correopersonal2" style="<?php echo $sStyleHidden_correopersonal2; ?>"><input type="hidden" name="correopersonal2" value="<?php echo $this->form_encode_input($correopersonal2); ?>"><span id="id_ajax_label_correopersonal2"><?php echo nl2br($correopersonal2); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_correolaboral2_label" id="hidden_field_label_correolaboral2" style="<?php echo $sStyleHidden_correolaboral2; ?>"><span id="id_label_correolaboral2"><?php echo $this->nm_new_label['correolaboral2']; ?></span></TD>
    <TD class="scFormDataOdd css_correolaboral2_line" id="hidden_field_data_correolaboral2" style="<?php echo $sStyleHidden_correolaboral2; ?>"><input type="hidden" name="correolaboral2" value="<?php echo $this->form_encode_input($correolaboral2); ?>"><span id="id_ajax_label_correolaboral2"><?php echo nl2br($correolaboral2); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf21_label" id="hidden_field_label_tf21" style="<?php echo $sStyleHidden_tf21; ?>"><span id="id_label_tf21"><?php echo $this->nm_new_label['tf21']; ?></span></TD>
    <TD class="scFormDataOdd css_tf21_line" id="hidden_field_data_tf21" style="<?php echo $sStyleHidden_tf21; ?>"><input type="hidden" name="tf21" value="<?php echo $this->form_encode_input($tf21); ?>"><span id="id_ajax_label_tf21"><?php echo nl2br($tf21); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf22_label" id="hidden_field_label_tf22" style="<?php echo $sStyleHidden_tf22; ?>"><span id="id_label_tf22"><?php echo $this->nm_new_label['tf22']; ?></span></TD>
    <TD class="scFormDataOdd css_tf22_line" id="hidden_field_data_tf22" style="<?php echo $sStyleHidden_tf22; ?>"><input type="hidden" name="tf22" value="<?php echo $this->form_encode_input($tf22); ?>"><span id="id_ajax_label_tf22"><?php echo nl2br($tf22); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf23_label" id="hidden_field_label_tf23" style="<?php echo $sStyleHidden_tf23; ?>"><span id="id_label_tf23"><?php echo $this->nm_new_label['tf23']; ?></span></TD>
    <TD class="scFormDataOdd css_tf23_line" id="hidden_field_data_tf23" style="<?php echo $sStyleHidden_tf23; ?>"><input type="hidden" name="tf23" value="<?php echo $this->form_encode_input($tf23); ?>"><span id="id_ajax_label_tf23"><?php echo nl2br($tf23); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf24_label" id="hidden_field_label_tf24" style="<?php echo $sStyleHidden_tf24; ?>"><span id="id_label_tf24"><?php echo $this->nm_new_label['tf24']; ?></span></TD>
    <TD class="scFormDataOdd css_tf24_line" id="hidden_field_data_tf24" style="<?php echo $sStyleHidden_tf24; ?>"><input type="hidden" name="tf24" value="<?php echo $this->form_encode_input($tf24); ?>"><span id="id_ajax_label_tf24"><?php echo nl2br($tf24); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf25_label" id="hidden_field_label_tf25" style="<?php echo $sStyleHidden_tf25; ?>"><span id="id_label_tf25"><?php echo $this->nm_new_label['tf25']; ?></span></TD>
    <TD class="scFormDataOdd css_tf25_line" id="hidden_field_data_tf25" style="<?php echo $sStyleHidden_tf25; ?>"><input type="hidden" name="tf25" value="<?php echo $this->form_encode_input($tf25); ?>"><span id="id_ajax_label_tf25"><?php echo nl2br($tf25); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf26_label" id="hidden_field_label_tf26" style="<?php echo $sStyleHidden_tf26; ?>"><span id="id_label_tf26"><?php echo $this->nm_new_label['tf26']; ?></span></TD>
    <TD class="scFormDataOdd css_tf26_line" id="hidden_field_data_tf26" style="<?php echo $sStyleHidden_tf26; ?>"><input type="hidden" name="tf26" value="<?php echo $this->form_encode_input($tf26); ?>"><span id="id_ajax_label_tf26"><?php echo nl2br($tf26); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf27_label" id="hidden_field_label_tf27" style="<?php echo $sStyleHidden_tf27; ?>"><span id="id_label_tf27"><?php echo $this->nm_new_label['tf27']; ?></span></TD>
    <TD class="scFormDataOdd css_tf27_line" id="hidden_field_data_tf27" style="<?php echo $sStyleHidden_tf27; ?>"><input type="hidden" name="tf27" value="<?php echo $this->form_encode_input($tf27); ?>"><span id="id_ajax_label_tf27"><?php echo nl2br($tf27); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf28_label" id="hidden_field_label_tf28" style="<?php echo $sStyleHidden_tf28; ?>"><span id="id_label_tf28"><?php echo $this->nm_new_label['tf28']; ?></span></TD>
    <TD class="scFormDataOdd css_tf28_line" id="hidden_field_data_tf28" style="<?php echo $sStyleHidden_tf28; ?>"><input type="hidden" name="tf28" value="<?php echo $this->form_encode_input($tf28); ?>"><span id="id_ajax_label_tf28"><?php echo nl2br($tf28); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf29_label" id="hidden_field_label_tf29" style="<?php echo $sStyleHidden_tf29; ?>"><span id="id_label_tf29"><?php echo $this->nm_new_label['tf29']; ?></span></TD>
    <TD class="scFormDataOdd css_tf29_line" id="hidden_field_data_tf29" style="<?php echo $sStyleHidden_tf29; ?>"><input type="hidden" name="tf29" value="<?php echo $this->form_encode_input($tf29); ?>"><span id="id_ajax_label_tf29"><?php echo nl2br($tf29); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombreasociado3_label" id="hidden_field_label_nombreasociado3" style="<?php echo $sStyleHidden_nombreasociado3; ?>"><span id="id_label_nombreasociado3"><?php echo $this->nm_new_label['nombreasociado3']; ?></span></TD>
    <TD class="scFormDataOdd css_nombreasociado3_line" id="hidden_field_data_nombreasociado3" style="<?php echo $sStyleHidden_nombreasociado3; ?>"><input type="hidden" name="nombreasociado3" value="<?php echo $this->form_encode_input($nombreasociado3); ?>"><span id="id_ajax_label_nombreasociado3"><?php echo nl2br($nombreasociado3); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipodocumento3_label" id="hidden_field_label_tipodocumento3" style="<?php echo $sStyleHidden_tipodocumento3; ?>"><span id="id_label_tipodocumento3"><?php echo $this->nm_new_label['tipodocumento3']; ?></span></TD>
    <TD class="scFormDataOdd css_tipodocumento3_line" id="hidden_field_data_tipodocumento3" style="<?php echo $sStyleHidden_tipodocumento3; ?>"><input type="hidden" name="tipodocumento3" value="<?php echo $this->form_encode_input($tipodocumento3); ?>"><span id="id_ajax_label_tipodocumento3"><?php echo nl2br($tipodocumento3); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numerodocumento3_label" id="hidden_field_label_numerodocumento3" style="<?php echo $sStyleHidden_numerodocumento3; ?>"><span id="id_label_numerodocumento3"><?php echo $this->nm_new_label['numerodocumento3']; ?></span></TD>
    <TD class="scFormDataOdd css_numerodocumento3_line" id="hidden_field_data_numerodocumento3" style="<?php echo $sStyleHidden_numerodocumento3; ?>"><input type="hidden" name="numerodocumento3" value="<?php echo $this->form_encode_input($numerodocumento3); ?>"><span id="id_ajax_label_numerodocumento3"><?php echo nl2br($numerodocumento3); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ubicacion3_label" id="hidden_field_label_ubicacion3" style="<?php echo $sStyleHidden_ubicacion3; ?>"><span id="id_label_ubicacion3"><?php echo $this->nm_new_label['ubicacion3']; ?></span></TD>
    <TD class="scFormDataOdd css_ubicacion3_line" id="hidden_field_data_ubicacion3" style="<?php echo $sStyleHidden_ubicacion3; ?>"><input type="hidden" name="ubicacion3" value="<?php echo $this->form_encode_input($ubicacion3); ?>"><span id="id_ajax_label_ubicacion3"><?php echo nl2br($ubicacion3); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_correopersonal3_label" id="hidden_field_label_correopersonal3" style="<?php echo $sStyleHidden_correopersonal3; ?>"><span id="id_label_correopersonal3"><?php echo $this->nm_new_label['correopersonal3']; ?></span></TD>
    <TD class="scFormDataOdd css_correopersonal3_line" id="hidden_field_data_correopersonal3" style="<?php echo $sStyleHidden_correopersonal3; ?>"><input type="hidden" name="correopersonal3" value="<?php echo $this->form_encode_input($correopersonal3); ?>"><span id="id_ajax_label_correopersonal3"><?php echo nl2br($correopersonal3); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_correolaboral3_label" id="hidden_field_label_correolaboral3" style="<?php echo $sStyleHidden_correolaboral3; ?>"><span id="id_label_correolaboral3"><?php echo $this->nm_new_label['correolaboral3']; ?></span></TD>
    <TD class="scFormDataOdd css_correolaboral3_line" id="hidden_field_data_correolaboral3" style="<?php echo $sStyleHidden_correolaboral3; ?>"><input type="hidden" name="correolaboral3" value="<?php echo $this->form_encode_input($correolaboral3); ?>"><span id="id_ajax_label_correolaboral3"><?php echo nl2br($correolaboral3); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf31_label" id="hidden_field_label_tf31" style="<?php echo $sStyleHidden_tf31; ?>"><span id="id_label_tf31"><?php echo $this->nm_new_label['tf31']; ?></span></TD>
    <TD class="scFormDataOdd css_tf31_line" id="hidden_field_data_tf31" style="<?php echo $sStyleHidden_tf31; ?>"><input type="hidden" name="tf31" value="<?php echo $this->form_encode_input($tf31); ?>"><span id="id_ajax_label_tf31"><?php echo nl2br($tf31); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf32_label" id="hidden_field_label_tf32" style="<?php echo $sStyleHidden_tf32; ?>"><span id="id_label_tf32"><?php echo $this->nm_new_label['tf32']; ?></span></TD>
    <TD class="scFormDataOdd css_tf32_line" id="hidden_field_data_tf32" style="<?php echo $sStyleHidden_tf32; ?>"><input type="hidden" name="tf32" value="<?php echo $this->form_encode_input($tf32); ?>"><span id="id_ajax_label_tf32"><?php echo nl2br($tf32); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf33_label" id="hidden_field_label_tf33" style="<?php echo $sStyleHidden_tf33; ?>"><span id="id_label_tf33"><?php echo $this->nm_new_label['tf33']; ?></span></TD>
    <TD class="scFormDataOdd css_tf33_line" id="hidden_field_data_tf33" style="<?php echo $sStyleHidden_tf33; ?>"><input type="hidden" name="tf33" value="<?php echo $this->form_encode_input($tf33); ?>"><span id="id_ajax_label_tf33"><?php echo nl2br($tf33); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf34_label" id="hidden_field_label_tf34" style="<?php echo $sStyleHidden_tf34; ?>"><span id="id_label_tf34"><?php echo $this->nm_new_label['tf34']; ?></span></TD>
    <TD class="scFormDataOdd css_tf34_line" id="hidden_field_data_tf34" style="<?php echo $sStyleHidden_tf34; ?>"><input type="hidden" name="tf34" value="<?php echo $this->form_encode_input($tf34); ?>"><span id="id_ajax_label_tf34"><?php echo nl2br($tf34); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf35_label" id="hidden_field_label_tf35" style="<?php echo $sStyleHidden_tf35; ?>"><span id="id_label_tf35"><?php echo $this->nm_new_label['tf35']; ?></span></TD>
    <TD class="scFormDataOdd css_tf35_line" id="hidden_field_data_tf35" style="<?php echo $sStyleHidden_tf35; ?>"><input type="hidden" name="tf35" value="<?php echo $this->form_encode_input($tf35); ?>"><span id="id_ajax_label_tf35"><?php echo nl2br($tf35); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf36_label" id="hidden_field_label_tf36" style="<?php echo $sStyleHidden_tf36; ?>"><span id="id_label_tf36"><?php echo $this->nm_new_label['tf36']; ?></span></TD>
    <TD class="scFormDataOdd css_tf36_line" id="hidden_field_data_tf36" style="<?php echo $sStyleHidden_tf36; ?>"><input type="hidden" name="tf36" value="<?php echo $this->form_encode_input($tf36); ?>"><span id="id_ajax_label_tf36"><?php echo nl2br($tf36); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf37_label" id="hidden_field_label_tf37" style="<?php echo $sStyleHidden_tf37; ?>"><span id="id_label_tf37"><?php echo $this->nm_new_label['tf37']; ?></span></TD>
    <TD class="scFormDataOdd css_tf37_line" id="hidden_field_data_tf37" style="<?php echo $sStyleHidden_tf37; ?>"><input type="hidden" name="tf37" value="<?php echo $this->form_encode_input($tf37); ?>"><span id="id_ajax_label_tf37"><?php echo nl2br($tf37); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf38_label" id="hidden_field_label_tf38" style="<?php echo $sStyleHidden_tf38; ?>"><span id="id_label_tf38"><?php echo $this->nm_new_label['tf38']; ?></span></TD>
    <TD class="scFormDataOdd css_tf38_line" id="hidden_field_data_tf38" style="<?php echo $sStyleHidden_tf38; ?>"><input type="hidden" name="tf38" value="<?php echo $this->form_encode_input($tf38); ?>"><span id="id_ajax_label_tf38"><?php echo nl2br($tf38); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tf39_label" id="hidden_field_label_tf39" style="<?php echo $sStyleHidden_tf39; ?>"><span id="id_label_tf39"><?php echo $this->nm_new_label['tf39']; ?></span></TD>
    <TD class="scFormDataOdd css_tf39_line" id="hidden_field_data_tf39" style="<?php echo $sStyleHidden_tf39; ?>"><input type="hidden" name="tf39" value="<?php echo $this->form_encode_input($tf39); ?>"><span id="id_ajax_label_tf39"><?php echo nl2br($tf39); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cantidadintentos_label" id="hidden_field_label_cantidadintentos" style="<?php echo $sStyleHidden_cantidadintentos; ?>"><span id="id_label_cantidadintentos"><?php echo $this->nm_new_label['cantidadintentos']; ?></span></TD>
    <TD class="scFormDataOdd css_cantidadintentos_line" id="hidden_field_data_cantidadintentos" style="<?php echo $sStyleHidden_cantidadintentos; ?>"><input type="hidden" name="cantidadintentos" value="<?php echo $this->form_encode_input($cantidadintentos); ?>"><span id="id_ajax_label_cantidadintentos"><?php echo nl2br($cantidadintentos); ?></span>
</TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['Lookup_estado'][] = '1'; ?>
<?php  if ("1" == $this->estado)  { echo " checked" ;} ?>  onClick="do_ajax_Formulario_Llamada_Bienvenida_event_estado_onclick();" ><span></span>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['Lookup_estado'][] = '0'; ?>
<?php  if ("0" == $this->estado)  { echo " checked" ;} ?>  onClick="do_ajax_Formulario_Llamada_Bienvenida_event_estado_onclick();" ><span></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_indicadorexitoconforme_label" id="hidden_field_label_indicadorexitoconforme" style="<?php echo $sStyleHidden_indicadorexitoconforme; ?>"><span id="id_label_indicadorexitoconforme"><?php echo $this->nm_new_label['indicadorexitoconforme']; ?></span></TD>
    <TD class="scFormDataOdd css_indicadorexitoconforme_line" id="hidden_field_data_indicadorexitoconforme" style="<?php echo $sStyleHidden_indicadorexitoconforme; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['Lookup_indicadorexitoconforme'][] = '1'; ?>
<?php  if ("1" == $this->indicadorexitoconforme)  { echo " checked" ;} ?>  onClick="do_ajax_Formulario_Llamada_Bienvenida_event_indicadorexitoconforme_onclick();" ><label for="<?php echo $tempOptionId ?>">Conforme</label></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['Lookup_indicadorexitoconforme'][] = '0'; ?>
<?php  if ("0" == $this->indicadorexitoconforme)  { echo " checked" ;} ?>  onClick="do_ajax_Formulario_Llamada_Bienvenida_event_indicadorexitoconforme_onclick();" ><label for="<?php echo $tempOptionId ?>">No Conforme</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
</TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_motivoc_label" id="hidden_field_label_motivoc" style="<?php echo $sStyleHidden_motivoc; ?>"><span id="id_label_motivoc"><?php echo $this->nm_new_label['motivoc']; ?></span></TD>
    <TD class="scFormDataOdd css_motivoc_line" id="hidden_field_data_motivoc" style="<?php echo $sStyleHidden_motivoc; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_comentario_line" id="hidden_field_data_comentario" style="<?php echo $sStyleHidden_comentario; ?>">
<?php
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bok", "scBtnFn_sys_format_ok()", "scBtnFn_sys_format_ok()", "sub_form_b", "", "Guardar", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-1", "", "");?>
...
<?php
           if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['Whatsapp'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "whatsapp", "scBtnFn_Whatsapp()", "scBtnFn_Whatsapp()", "sc_Whatsapp_bot", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
           if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['enviarCorreo'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "enviarcorreo", "scBtnFn_enviarCorreo()", "scBtnFn_enviarCorreo()", "sc_enviarCorreo_bot", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("Formulario_Llamada_Bienvenida");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("Formulario_Llamada_Bienvenida");
 parent.scAjaxDetailHeight("Formulario_Llamada_Bienvenida", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
