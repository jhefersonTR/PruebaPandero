...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="Formulario_Llamada_Bienvenida_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_Volver()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Está seguro de regresar al formulario sin guardar ? ', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_Volver_ok, sc_btn_Volver_cancel)
}
...
function sc_btn_Guardar()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Está seguro de guardar? ', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_Guardar_ok, sc_btn_Guardar_cancel)
}
...
function sc_btn_enviarCorreo_ok()
{
    ...
    document.F1.action = "Formulario_Llamada_Bienvenida_mob.php";
...
function nm_saida_glo()
{
  ...
  document.F4.action = "Formulario_Llamada_Bienvenida_mob_fim.php";
  document.F4.submit();
}
