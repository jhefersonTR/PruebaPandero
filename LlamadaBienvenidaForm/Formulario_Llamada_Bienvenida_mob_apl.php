<?php
//
class Formulario_Llamada_Bienvenida_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->ContratoNum) && isset($this->contratonum)) 
          {
              $this->ContratoNum = $this->contratonum;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new Formulario_Llamada_Bienvenida_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['Formulario_Llamada_Bienvenida_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Formulario_Llamada_Bienvenida_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Formulario_Llamada_Bienvenida_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Formulario_Llamada_Bienvenida_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Formulario_Llamada_Bienvenida_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('Formulario_Llamada_Bienvenida_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Formulario_Llamada_Bienvenida_mob']['label'] = "LLAMADA DE BIENVENIDA";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "Formulario_Llamada_Bienvenida_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['Formulario_Llamada_Bienvenida_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['Formulario_Llamada_Bienvenida_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Formulario_Llamada_Bienvenida_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Formulario_Llamada_Bienvenida_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Formulario_Llamada_Bienvenida_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("Formulario_Llamada_Bienvenida_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'Formulario_Llamada_Bienvenida_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'Formulario_Llamada_Bienvenida_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'LlamadaBienvenidaForm/Formulario_Llamada_Bienvenida_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "Formulario_Llamada_Bienvenida_mob_erro.class.php"); 
      }
      $this->Erro      = new Formulario_Llamada_Bienvenida_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['Formulario_Llamada_Bienvenida_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['Volver'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['botoes']['Volver'];
          $this->nmgp_botoes['Guardar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['botoes']['Guardar'];
          $this->nmgp_botoes['enviarCorreo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['botoes']['enviarCorreo'];
          $this->nmgp_botoes['llamada'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['botoes']['llamada'];
          $this->nmgp_botoes['Whatsapp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['botoes']['Whatsapp'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      {
      $_SESSION['scriptcase']['Formulario_Llamada_Bienvenida_mob']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_ContratoID)) {$this->sc_temp_ContratoID = (isset($_SESSION['ContratoID'])) ? $_SESSION['ContratoID'] : "";}
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_Formulario_Llamada_Bienvenida_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['Formulario_Llamada_Bienvenida_mob']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['Formulario_Llamada_Bienvenida_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['Formulario_Llamada_Bienvenida_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['contratonumero']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->contratonumero = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['contratonumero'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['nombreedv']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nombreedv = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['nombreedv'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['supervisor']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->supervisor = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['supervisor'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['fechaventa']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fechaventa = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['fechaventa'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['grupofechainauguracion']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->grupofechainauguracion = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['grupofechainauguracion'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['nombreasociaso']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nombreasociaso = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['nombreasociaso'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tipodocumento1']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tipodocumento1 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tipodocumento1'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['numerodocumento1']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numerodocumento1 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['numerodocumento1'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['ubicacion']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->ubicacion = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['ubicacion'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correopersonal1']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->correopersonal1 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correopersonal1'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correolaboral1']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->correolaboral1 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correolaboral1'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf11']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf11 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf11'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf13']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf13 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf13'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf12']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf12 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf12'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf14']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf14 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf14'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf15']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf15 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf15'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf16']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf16 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf16'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf17']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf17 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf17'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf18']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf18 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf18'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf19']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf19 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf19'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['nombreasociado2']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nombreasociado2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['nombreasociado2'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tipodocumento2']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tipodocumento2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tipodocumento2'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['numerodocumento2']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numerodocumento2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['numerodocumento2'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['ubicacion2']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->ubicacion2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['ubicacion2'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correopersonal2']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->correopersonal2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correopersonal2'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correolaboral2']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->correolaboral2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correolaboral2'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf21']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf21 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf21'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf22']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf22 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf22'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf23']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf23 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf23'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf24']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf24 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf24'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf25']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf25 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf25'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf26']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf26 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf26'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf27']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf27 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf27'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf28']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf28 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf28'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf29']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf29 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf29'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['nombreasociado3']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nombreasociado3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['nombreasociado3'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tipodocumento3']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tipodocumento3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tipodocumento3'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['numerodocumento3']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numerodocumento3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['numerodocumento3'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['ubicacion3']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->ubicacion3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['ubicacion3'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correopersonal3']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->correopersonal3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correopersonal3'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correolaboral3']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->correolaboral3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['correolaboral3'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf31']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf31 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf31'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf32']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf32 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf32'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf33']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf33 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf33'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf34']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf34 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf34'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf35']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf35 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf35'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf36']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf36 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf36'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf37']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf37 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf37'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf38']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf38 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf38'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf39']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tf39 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['tf39'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['cantidadintentos']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cantidadintentos = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_select']['cantidadintentos'];
          } 
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->ubicacion2 = "" ;  
          $this->ubicacion3 = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos']))
              { 
                  $contratonumero = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][0]; 
                  $nombreedv = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][1]; 
                  $supervisor = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][2]; 
                  $fechaventa = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][3]; 
                  $grupofechainauguracion = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][4]; 
                  $nombreasociaso = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][5]; 
                  $tipodocumento1 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][6]; 
                  $numerodocumento1 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][7]; 
                  $ubicacion = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][8]; 
                  $correopersonal1 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][9]; 
                  $correolaboral1 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][10]; 
                  $tf11 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][11]; 
                  $tf13 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][12]; 
                  $tf12 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][13]; 
                  $tf14 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][14]; 
                  $tf15 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][15]; 
                  $tf16 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][16]; 
                  $tf17 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][17]; 
                  $tf18 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][18]; 
                  $tf19 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][19]; 
                  $nombreasociado2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][20]; 
                  $tipodocumento2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][21]; 
                  $numerodocumento2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][22]; 
                  $ubicacion2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][23]; 
                  $correopersonal2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][24]; 
                  $correolaboral2 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][25]; 
                  $tf21 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][26]; 
                  $tf22 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][27]; 
                  $tf23 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][28]; 
                  $tf24 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][29]; 
                  $tf25 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][30]; 
                  $tf26 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][31]; 
                  $tf27 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][32]; 
                  $tf28 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][33]; 
                  $tf29 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][34]; 
                  $nombreasociado3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][35]; 
                  $tipodocumento3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][36]; 
                  $numerodocumento3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][37]; 
                  $ubicacion3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][38]; 
                  $correopersonal3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][39]; 
                  $correolaboral3 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][40]; 
                  $tf31 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][41]; 
                  $tf32 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][42]; 
                  $tf33 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][43]; 
                  $tf34 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][44]; 
                  $tf35 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][45]; 
                  $tf36 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][46]; 
                  $tf37 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][47]; 
                  $tf38 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][48]; 
                  $tf39 = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][49]; 
                  $cantidadintentos = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][50]; 
                  $telefono = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][51]; 
                  $estado = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][52]; 
                  $indicadorexitoconforme = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][53]; 
                  $motivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][54]; 
                  $motivoc = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][55]; 
                  $comentario = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][56]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][0] = $this->contratonumero; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][1] = $this->nombreedv; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][2] = $this->supervisor; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][3] = $this->fechaventa; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][4] = $this->grupofechainauguracion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][5] = $this->nombreasociaso; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][6] = $this->tipodocumento1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][7] = $this->numerodocumento1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][8] = $this->ubicacion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][9] = $this->correopersonal1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][10] = $this->correolaboral1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][11] = $this->tf11; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][12] = $this->tf13; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][13] = $this->tf12; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][14] = $this->tf14; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][15] = $this->tf15; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][16] = $this->tf16; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][17] = $this->tf17; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][18] = $this->tf18; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][19] = $this->tf19; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][20] = $this->nombreasociado2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][21] = $this->tipodocumento2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][22] = $this->numerodocumento2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][23] = $this->ubicacion2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][24] = $this->correopersonal2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][25] = $this->correolaboral2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][26] = $this->tf21; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][27] = $this->tf22; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][28] = $this->tf23; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][29] = $this->tf24; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][30] = $this->tf25; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][31] = $this->tf26; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][32] = $this->tf27; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][33] = $this->tf28; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][34] = $this->tf29; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][35] = $this->nombreasociado3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][36] = $this->tipodocumento3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][37] = $this->numerodocumento3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][38] = $this->ubicacion3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][39] = $this->correopersonal3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][40] = $this->correolaboral3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][41] = $this->tf31; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][42] = $this->tf32; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][43] = $this->tf33; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][44] = $this->tf34; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][45] = $this->tf35; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][46] = $this->tf36; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][47] = $this->tf37; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][48] = $this->tf38; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][49] = $this->tf39; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][50] = $this->cantidadintentos; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][51] = $this->telefono; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][52] = $this->estado; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][53] = $this->indicadorexitoconforme; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][54] = $this->motivo; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][55] = $this->motivoc; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['campos'][56] = $this->comentario; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("Formulario_Llamada_Bienvenida_mob", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("Formulario_Llamada_Bienvenida_mob_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "Formulario_Llamada_Bienvenida_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="Formulario_Llamada_Bienvenida_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="Formulario_Llamada_Bienvenida_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="Formulario_Llamada_Bienvenida_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opc_ant'] == "incluir")
      {
          $nmgp_opc_ant_saida_php = "novo";
          $nmgp_opcao_saida_php   = "recarga";
      }
      $nm_f_saida = "Formulario_Llamada_Bienvenida_mob.php";
...
;
    ...
    function ValidateField_estado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->estado != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_estado']) && !in_array($this->estado, $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_estado']))
          {
              $hasError = true;
    ...
    function ValidateField_indicadorexitoconforme(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_indicadorexitoconforme']) && !in_array($this->indicadorexitoconforme, $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_indicadorexitoconforme']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_motivo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->motivo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_motivo']) && !in_array($this->motivo, $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_motivo']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_motivoc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->motivoc) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_motivoc']) && !in_array($this->motivoc, $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_motivoc']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
$aLookup[] = array(Formulario_Llamada_Bienvenida_mob_pack_protect_string('1') => str_replace('<', '&lt;',Formulario_Llamada_Bienvenida_mob_pack_protect_string("Exitosa")));
$aLookup[] = array(Formulario_Llamada_Bienvenida_mob_pack_protect_string('0') => str_replace('<', '&lt;',Formulario_Llamada_Bienvenida_mob_pack_protect_string("No exitosa")));
$_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_estado'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_estado'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estado']['valList'][$i] = Formulario_Llamada_Bienvenida_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(Formulario_Llamada_Bienvenida_mob_pack_protect_string('1') => str_replace('<', '&lt;',Formulario_Llamada_Bienvenida_mob_pack_protect_string("Conforme")));
$aLookup[] = array(Formulario_Llamada_Bienvenida_mob_pack_protect_string('0') => str_replace('<', '&lt;',Formulario_Llamada_Bienvenida_mob_pack_protect_string("No Conforme")));
$_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_indicadorexitoconforme'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['Lookup_indicadorexitoconforme'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['indicadorexitoconforme']['valList'][$i] = Formulario_Llamada_Bienvenida_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(Formulario_Llamada_Bienvenida_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', Formulario_Llamada_Bienvenida_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['motivo']['valList'][$i] = Formulario_Llamada_Bienvenida_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['motivoc']['valList'][$i] = Formulario_Llamada_Bienvenida_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_comentario($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
if (isset($this->Campos_Mens_erro) && !empty($this->Campos_Mens_erro))
{
 ...
 if (isset($this->sc_temp_probando_prueba1)) { $_SESSION['probando_prueba1'] = $this->sc_temp_probando_prueba1;}
    if ($this->NM_ajax_flag)
    {
        $this->NM_ajax_info['redirExit']['action'] = "Formulario_Llamada_Bienvenida_mob_fim.php?script_case_init=" . $this->form_encode_input($this->Ini->sc_page);
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['sc_outra_jan'])
        {
            $_SESSION['scriptcase']['sc_outra_jan'] = "Formulario_Llamada_Bienvenida_mob";
            $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['sc_outra_jan'] = false;
        }
        $_SESSION['scriptcase']['Formulario_Llamada_Bienvenida_mob']['contr_erro'] = 'off';
        Formulario_Llamada_Bienvenida_mob_pack_ajax_response();
        exit;
...
<table align="center"><tr><td>
  <form name="Fexit" method=post
        action="Formulario_Llamada_Bienvenida_mob_fim.php"
        target="_self">
    <input type=hidden name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page) ?>">
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
$_SESSION['scriptcase']['Formulario_Llamada_Bienvenida_mob']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("Formulario_Llamada_Bienvenida_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['table_refresh'])
        {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "Formulario_Llamada_Bienvenida_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "Formulario_Llamada_Bienvenida_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
}
?>
