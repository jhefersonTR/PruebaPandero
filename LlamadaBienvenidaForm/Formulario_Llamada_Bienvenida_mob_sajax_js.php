  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Formulario_Llamada_Bienvenida_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_Formulario_Llamada_Bienvenida_mob_form();
	}
  ...
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_contratonumero()
  {
    ...
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_contratonumero(var_contratonumero, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_contratonumero_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_contratonumero

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_contratonumero_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_contratonumero_cb

  // ---------- Validate nombreedv
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreedv()
  {
    var nomeCampo_nombreedv = "nombreedv";
    var var_nombreedv = scAjaxGetFieldHidden(nomeCampo_nombreedv);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreedv(var_nombreedv, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreedv_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreedv

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreedv_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreedv_cb

  // ---------- Validate supervisor
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_supervisor()
  {
    var nomeCampo_supervisor = "supervisor";
    var var_supervisor = scAjaxGetFieldHidden(nomeCampo_supervisor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_supervisor(var_supervisor, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_supervisor_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_supervisor

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_supervisor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_supervisor_cb

  // ---------- Validate fechaventa
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_fechaventa()
  {
    var nomeCampo_fechaventa = "fechaventa";
    var var_fechaventa = scAjaxGetFieldHidden(nomeCampo_fechaventa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_fechaventa(var_fechaventa, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_fechaventa_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_fechaventa

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_fechaventa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_fechaventa_cb

  // ---------- Validate grupofechainauguracion
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_grupofechainauguracion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_grupofechainauguracion(var_grupofechainauguracion, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_grupofechainauguracion_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_grupofechainauguracion

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_grupofechainauguracion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_grupofechainauguracion_cb

  // ---------- Validate nombreasociaso
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociaso()
  {
    var nomeCampo_nombreasociaso = "nombreasociaso";
    var var_nombreasociaso = scAjaxGetFieldHidden(nomeCampo_nombreasociaso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociaso(var_nombreasociaso, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociaso_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociaso

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociaso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociaso_cb

  // ---------- Validate tipodocumento1
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento1()
  {
    var nomeCampo_tipodocumento1 = "tipodocumento1";
    var var_tipodocumento1 = scAjaxGetFieldHidden(nomeCampo_tipodocumento1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento1(var_tipodocumento1, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento1_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento1

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento1_cb

  // ---------- Validate numerodocumento1
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento1()
  {
    var nomeCampo_numerodocumento1 = "numerodocumento1";
    var var_numerodocumento1 = scAjaxGetFieldHidden(nomeCampo_numerodocumento1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento1(var_numerodocumento1, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento1_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento1

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento1_cb

  // ---------- Validate ubicacion
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion()
  {
    var nomeCampo_ubicacion = "ubicacion";
    var var_ubicacion = scAjaxGetFieldHidden(nomeCampo_ubicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion(var_ubicacion, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion_cb

  // ---------- Validate correopersonal1
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal1()
  {
    var nomeCampo_correopersonal1 = "correopersonal1";
    var var_correopersonal1 = scAjaxGetFieldHidden(nomeCampo_correopersonal1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal1(var_correopersonal1, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal1_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal1

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal1_cb

  // ---------- Validate correolaboral1
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral1()
  {
    var nomeCampo_correolaboral1 = "correolaboral1";
    var var_correolaboral1 = scAjaxGetFieldHidden(nomeCampo_correolaboral1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral1(var_correolaboral1, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral1_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral1

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral1_cb

  // ---------- Validate tf11
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf11()
  {
    var nomeCampo_tf11 = "tf11";
    var var_tf11 = scAjaxGetFieldHidden(nomeCampo_tf11);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf11(var_tf11, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf11_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf11

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf11_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf11";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf11_cb

  // ---------- Validate tf13
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf13()
  {
    var nomeCampo_tf13 = "tf13";
    var var_tf13 = scAjaxGetFieldHidden(nomeCampo_tf13);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf13(var_tf13, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf13_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf13

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf13_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf13";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf13_cb

  // ---------- Validate tf12
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf12()
  {
    var nomeCampo_tf12 = "tf12";
    var var_tf12 = scAjaxGetFieldHidden(nomeCampo_tf12);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf12(var_tf12, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf12_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf12

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf12_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf12";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf12_cb

  // ---------- Validate tf14
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf14()
  {
    var nomeCampo_tf14 = "tf14";
    var var_tf14 = scAjaxGetFieldHidden(nomeCampo_tf14);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf14(var_tf14, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf14_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf14

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf14_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf14";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf14_cb

  // ---------- Validate tf15
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf15()
  {
    var nomeCampo_tf15 = "tf15";
    var var_tf15 = scAjaxGetFieldHidden(nomeCampo_tf15);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf15(var_tf15, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf15_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf15

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf15_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf15";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf15_cb

  // ---------- Validate tf16
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf16()
  {
    var nomeCampo_tf16 = "tf16";
    var var_tf16 = scAjaxGetFieldHidden(nomeCampo_tf16);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf16(var_tf16, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf16_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf16

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf16_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf16";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf16_cb

  // ---------- Validate tf17
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf17()
  {
    var nomeCampo_tf17 = "tf17";
    var var_tf17 = scAjaxGetFieldHidden(nomeCampo_tf17);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf17(var_tf17, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf17_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf17

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf17_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf17";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf17_cb

  // ---------- Validate tf18
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf18()
  {
    var nomeCampo_tf18 = "tf18";
    var var_tf18 = scAjaxGetFieldHidden(nomeCampo_tf18);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf18(var_tf18, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf18_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf18

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf18_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf18";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf18_cb

  // ---------- Validate tf19
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf19()
  {
    var nomeCampo_tf19 = "tf19";
    var var_tf19 = scAjaxGetFieldHidden(nomeCampo_tf19);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf19(var_tf19, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf19_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf19

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf19_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf19";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf19_cb

  // ---------- Validate nombreasociado2
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado2()
  {
    var nomeCampo_nombreasociado2 = "nombreasociado2";
    var var_nombreasociado2 = scAjaxGetFieldHidden(nomeCampo_nombreasociado2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado2(var_nombreasociado2, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado2_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado2

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado2_cb

  // ---------- Validate tipodocumento2
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento2()
  {
    var nomeCampo_tipodocumento2 = "tipodocumento2";
    var var_tipodocumento2 = scAjaxGetFieldHidden(nomeCampo_tipodocumento2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento2(var_tipodocumento2, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento2_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento2

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento2_cb

  // ---------- Validate numerodocumento2
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento2()
  {
    var nomeCampo_numerodocumento2 = "numerodocumento2";
    var var_numerodocumento2 = scAjaxGetFieldHidden(nomeCampo_numerodocumento2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento2(var_numerodocumento2, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento2_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento2

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento2_cb

  // ---------- Validate ubicacion2
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion2()
  {
    var nomeCampo_ubicacion2 = "ubicacion2";
    var var_ubicacion2 = scAjaxGetFieldHidden(nomeCampo_ubicacion2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion2(var_ubicacion2, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion2_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion2

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion2_cb

  // ---------- Validate correopersonal2
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal2()
  {
    var nomeCampo_correopersonal2 = "correopersonal2";
    var var_correopersonal2 = scAjaxGetFieldHidden(nomeCampo_correopersonal2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal2(var_correopersonal2, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal2_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal2

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal2_cb

  // ---------- Validate correolaboral2
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral2()
  {
    var nomeCampo_correolaboral2 = "correolaboral2";
    var var_correolaboral2 = scAjaxGetFieldHidden(nomeCampo_correolaboral2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral2(var_correolaboral2, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral2_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral2

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral2_cb

  // ---------- Validate tf21
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf21()
  {
    var nomeCampo_tf21 = "tf21";
    var var_tf21 = scAjaxGetFieldHidden(nomeCampo_tf21);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf21(var_tf21, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf21_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf21

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf21_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf21";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf21_cb

  // ---------- Validate tf22
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf22()
  {
    var nomeCampo_tf22 = "tf22";
    var var_tf22 = scAjaxGetFieldHidden(nomeCampo_tf22);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf22(var_tf22, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf22_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf22

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf22_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf22";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf22_cb

  // ---------- Validate tf23
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf23()
  {
    var nomeCampo_tf23 = "tf23";
    var var_tf23 = scAjaxGetFieldHidden(nomeCampo_tf23);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf23(var_tf23, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf23_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf23

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf23_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf23";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf23_cb

  // ---------- Validate tf24
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf24()
  {
    var nomeCampo_tf24 = "tf24";
    var var_tf24 = scAjaxGetFieldHidden(nomeCampo_tf24);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf24(var_tf24, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf24_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf24

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf24_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf24";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf24_cb

  // ---------- Validate tf25
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf25()
  {
    var nomeCampo_tf25 = "tf25";
    var var_tf25 = scAjaxGetFieldHidden(nomeCampo_tf25);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf25(var_tf25, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf25_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf25

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf25_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf25";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf25_cb

  // ---------- Validate tf26
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf26()
  {
    var nomeCampo_tf26 = "tf26";
    var var_tf26 = scAjaxGetFieldHidden(nomeCampo_tf26);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf26(var_tf26, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf26_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf26

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf26_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf26";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf26_cb

  // ---------- Validate tf27
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf27()
  {
    var nomeCampo_tf27 = "tf27";
    var var_tf27 = scAjaxGetFieldHidden(nomeCampo_tf27);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf27(var_tf27, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf27_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf27

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf27_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf27";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf27_cb

  // ---------- Validate tf28
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf28()
  {
    var nomeCampo_tf28 = "tf28";
    var var_tf28 = scAjaxGetFieldHidden(nomeCampo_tf28);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf28(var_tf28, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf28_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf28

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf28_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf28";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf28_cb

  // ---------- Validate tf29
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf29()
  {
    var nomeCampo_tf29 = "tf29";
    var var_tf29 = scAjaxGetFieldHidden(nomeCampo_tf29);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf29(var_tf29, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf29_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf29

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf29_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf29";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf29_cb

  // ---------- Validate nombreasociado3
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado3()
  {
    var nomeCampo_nombreasociado3 = "nombreasociado3";
    var var_nombreasociado3 = scAjaxGetFieldHidden(nomeCampo_nombreasociado3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado3(var_nombreasociado3, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado3_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado3

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_nombreasociado3_cb

  // ---------- Validate tipodocumento3
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento3()
  {
    var nomeCampo_tipodocumento3 = "tipodocumento3";
    var var_tipodocumento3 = scAjaxGetFieldHidden(nomeCampo_tipodocumento3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento3(var_tipodocumento3, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento3_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento3

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tipodocumento3_cb

  // ---------- Validate numerodocumento3
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento3()
  {
    var nomeCampo_numerodocumento3 = "numerodocumento3";
    var var_numerodocumento3 = scAjaxGetFieldHidden(nomeCampo_numerodocumento3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento3(var_numerodocumento3, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento3_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento3

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_numerodocumento3_cb

  // ---------- Validate ubicacion3
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion3()
  {
    var nomeCampo_ubicacion3 = "ubicacion3";
    var var_ubicacion3 = scAjaxGetFieldHidden(nomeCampo_ubicacion3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion3(var_ubicacion3, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion3_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion3

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_ubicacion3_cb

  // ---------- Validate correopersonal3
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal3()
  {
    var nomeCampo_correopersonal3 = "correopersonal3";
    var var_correopersonal3 = scAjaxGetFieldHidden(nomeCampo_correopersonal3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal3(var_correopersonal3, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal3_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal3

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correopersonal3_cb

  // ---------- Validate correolaboral3
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral3()
  {
    var nomeCampo_correolaboral3 = "correolaboral3";
    var var_correolaboral3 = scAjaxGetFieldHidden(nomeCampo_correolaboral3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral3(var_correolaboral3, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral3_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral3

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_correolaboral3_cb

  // ---------- Validate tf31
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf31()
  {
    var nomeCampo_tf31 = "tf31";
    var var_tf31 = scAjaxGetFieldHidden(nomeCampo_tf31);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf31(var_tf31, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf31_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf31

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf31_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf31";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf31_cb

  // ---------- Validate tf32
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf32()
  {
    var nomeCampo_tf32 = "tf32";
    var var_tf32 = scAjaxGetFieldHidden(nomeCampo_tf32);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf32(var_tf32, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf32_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf32

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf32_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf32";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf32_cb

  // ---------- Validate tf33
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf33()
  {
    var nomeCampo_tf33 = "tf33";
    var var_tf33 = scAjaxGetFieldHidden(nomeCampo_tf33);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf33(var_tf33, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf33_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf33

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf33_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf33";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf33_cb

  // ---------- Validate tf34
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf34()
  {
    var nomeCampo_tf34 = "tf34";
    var var_tf34 = scAjaxGetFieldHidden(nomeCampo_tf34);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf34(var_tf34, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf34_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf34

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf34_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf34";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf34_cb

  // ---------- Validate tf35
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf35()
  {
    var nomeCampo_tf35 = "tf35";
    var var_tf35 = scAjaxGetFieldHidden(nomeCampo_tf35);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf35(var_tf35, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf35_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf35

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf35_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf35";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf35_cb

  // ---------- Validate tf36
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf36()
  {
    var nomeCampo_tf36 = "tf36";
    var var_tf36 = scAjaxGetFieldHidden(nomeCampo_tf36);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf36(var_tf36, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf36_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf36

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf36_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf36";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf36_cb

  // ---------- Validate tf37
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf37()
  {
    var nomeCampo_tf37 = "tf37";
    var var_tf37 = scAjaxGetFieldHidden(nomeCampo_tf37);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf37(var_tf37, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf37_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf37

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf37_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf37";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf37_cb

  // ---------- Validate tf38
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf38()
  {
    var nomeCampo_tf38 = "tf38";
    var var_tf38 = scAjaxGetFieldHidden(nomeCampo_tf38);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf38(var_tf38, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf38_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf38

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf38_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf38";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf38_cb

  // ---------- Validate tf39
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf39()
  {
    var nomeCampo_tf39 = "tf39";
    var var_tf39 = scAjaxGetFieldHidden(nomeCampo_tf39);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf39(var_tf39, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf39_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf39

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf39_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf39";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_tf39_cb

  // ---------- Validate cantidadintentos
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_cantidadintentos()
  {
    var nomeCampo_cantidadintentos = "cantidadintentos";
    var var_cantidadintentos = scAjaxGetFieldHidden(nomeCampo_cantidadintentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_cantidadintentos(var_cantidadintentos, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_cantidadintentos_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_cantidadintentos

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_cantidadintentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_cantidadintentos_cb

  // ---------- Validate telefono
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_telefono(var_telefono, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_telefono_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_telefono

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_telefono_cb

  // ---------- Validate estado
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldRadio(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_estado(var_estado, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_estado_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_estado

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_estado_cb

  // ---------- Validate indicadorexitoconforme
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_indicadorexitoconforme()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_indicadorexitoconforme(var_indicadorexitoconforme, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_indicadorexitoconforme_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_indicadorexitoconforme

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_indicadorexitoconforme_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_indicadorexitoconforme_cb

  // ---------- Validate motivo
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivo()
  {
    var nomeCampo_motivo = "motivo";
    var var_motivo = scAjaxGetFieldSelect(nomeCampo_motivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivo(var_motivo, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivo_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivo

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "motivo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivo_cb

  // ---------- Validate motivoc
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivoc()
  {
    var nomeCampo_motivoc = "motivoc";
    var var_motivoc = scAjaxGetFieldSelect(nomeCampo_motivoc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivoc(var_motivoc, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivoc_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivoc

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivoc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "motivoc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_motivoc_cb

  // ---------- Validate comentario
  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_comentario()
  {
    var nomeCampo_comentario = "comentario";
    var var_comentario = scAjaxGetFieldText(nomeCampo_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Formulario_Llamada_Bienvenida_mob_validate_comentario(var_comentario, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_validate_comentario_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_comentario

  function do_ajax_Formulario_Llamada_Bienvenida_mob_validate_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_validate_comentario_cb

  // ---------- Event onclick estado
  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_estado_onclick()
  {
    var var_estado = scAjaxGetFieldRadio("estado");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Formulario_Llamada_Bienvenida_mob_event_estado_onclick(var_estado, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_event_estado_onclick_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_estado_onclick

  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_estado_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estado";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Formulario_Llamada_Bienvenida_mob_event_estado_onclick_cb_after_alert);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_estado_onclick_cb
  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_estado_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_estado_onclick_cb_after_alert

  // ---------- Event onclick indicadorexitoconforme
  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_indicadorexitoconforme_onclick()
  {
    var var_indicadorexitoconforme = scAjaxGetFieldRadio("indicadorexitoconforme");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Formulario_Llamada_Bienvenida_mob_event_indicadorexitoconforme_onclick(var_indicadorexitoconforme, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_event_indicadorexitoconforme_onclick_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_indicadorexitoconforme_onclick

  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_indicadorexitoconforme_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "indicadorexitoconforme";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Formulario_Llamada_Bienvenida_mob_event_indicadorexitoconforme_onclick_cb_after_alert);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_indicadorexitoconforme_onclick_cb
  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_indicadorexitoconforme_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_indicadorexitoconforme_onclick_cb_after_alert

  // ---------- Event onclick scajaxbutton_volver
  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_volver_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_volver_onclick(var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_volver_onclick_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_volver_onclick

  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_volver_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_volver_onclick_cb_after_alert);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_volver_onclick_cb
  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_volver_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_volver_onclick_cb_after_alert

  // ---------- Event onclick scajaxbutton_guardar
  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_guardar_onclick()
  {
    var var_estado = scAjaxGetFieldRadio("estado");
    var var_indicadorexitoconforme = scAjaxGetFieldRadio("indicadorexitoconforme");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_guardar_onclick(var_estado, var_indicadorexitoconforme, var_motivoc, var_telefono, var_comentario, var_motivo, var_script_case_init, do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_guardar_onclick_cb);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_guardar_onclick

  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_guardar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_guardar_onclick_cb_after_alert);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_guardar_onclick_cb
  function do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_guardar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_event_scajaxbutton_guardar_onclick_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_Formulario_Llamada_Bienvenida_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_Formulario_Llamada_Bienvenida_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_Formulario_Llamada_Bienvenida_mob_submit_form_cb_after_alert);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_submit_form_cb
  function do_ajax_Formulario_Llamada_Bienvenida_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_Formulario_Llamada_Bienvenida_mob_navigate_form()
  {
    perform_ajax_Formulario_Llamada_Bienvenida_mob_navigate_form();
  }

  function perform_ajax_Formulario_Llamada_Bienvenida_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Formulario_Llamada_Bienvenida_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_Formulario_Llamada_Bienvenida_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_Formulario_Llamada_Bienvenida_mob_navigate_form_cb_after_alert);
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_navigate_form_cb
  function do_ajax_Formulario_Llamada_Bienvenida_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_Formulario_Llamada_Bienvenida_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Formulario_Llamada_Bienvenida_mob_navigate_form_cb_after_alert
  function sc_hide_Formulario_Llamada_Bienvenida_mob_form()
  {
